# Hydro_attr_merge.py
#
# This script clips the primary HydroATLAS attributes file to the Pacific Northwest - the scope of our gage dataset.
# It also deletes older streamflow gage information merged into the attribute data and prepares it to be updated with
# new gage data.
...
if __name__ == '__main__':
    ...
    df_final_name = 'HydroATLAS_final.csv'
    df_final.to_csv('H:/HydroATLAS/' + df_final_name, index=False)