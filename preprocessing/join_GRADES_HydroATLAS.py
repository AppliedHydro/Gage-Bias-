...
def findMidPoint():
    ...
    df = gpd.read_file('H:/GRADES/MERIT_Basins_v0.7_PNW/pfaf_07_riv_3sMERIT_PNW.shp')
    print('imported')
    ...
    data.to_file('C:/Users/stevenschmitz/Desktop/PlacementBias/Outputs/MERIT_riv_midpoint.shp')
...
def read_HydroATLAS():
	...
	layer = layers[0]
	llgpd = gpd.read_file('C:/Users/stevenschmitz/Desktop/PlacementBias/Outputs/HydroATLAS_spatialjoin.shp',layer=layer)[['REACH_ID','RIV_ORD','DOR','geometry']]
	print('read...')
	print(len(llgpd))
