...
```
<div class="centered">
***Gage Placement Bias: Testing `r test_variable`     |     `r date`***
</div>

The following figure shows the [Wasserstein Distance](https://www.sciencedirect.com/topics/mathematics/wasserstein-distance) of the 13 selected variables.
...
Below are variable distributions showing cumulative probabilities of variables occurrence. 
...
The GRADES river segment overlaid with satellite imagery


```{r leaflet, echo=FALSE,fig.keep='all',results='asis'}
# leaflet
