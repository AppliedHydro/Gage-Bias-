...
ggsave(bias_overview, file = file.path(output_path,Sys.Date(),"_bias overview.png") , width = 7, height = 5, units = "in", dpi = 300)
...
ggsave(grid1, file = file.path(output_path,Sys.Date(),"_grid1.png") , width = 7, height = 5, units = "in", dpi = 300)
...
ggsave(grid2, file = file.path(output_path,Sys.Date(),"_grid2.png") , width = 7, height = 5, units = "in", dpi = 300)
...
ggsave(map1, file = file.path(output_path,Sys.Date(),"_segment1.png") , width = 7, height = 5, units = "in", dpi = 300)
